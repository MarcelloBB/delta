  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        <Dialog.Trigger 
          type="button"
          className="border border-violet-700 font-semibold rounded-lg px-6 py-4 flex items-center gap-3 hover:"
        >
        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Close
              className="absolute right-6 top-6 text-zinc-400 focus:none hover:text-zinc-200 border-none"
            >
              <X 
                size={24}
                aria-label="Fechar"
